...
t20 = w1+w2;
t21 = 1.0./t20;
F_w2 = real((k.*t7.*(t11+t2.*t15).*(1.0./2.0))./w1+b.*t7.*t18.*t19.*t21.*w1.*(1.0./2.0)-alpha.*b.*t7.*t18.*t21.*w1.*w2.*(1.0./2.0)-b.*t7.*t18.*t19.*1.0./t20.^2.*w1.*w2.*(1.0./2.0));
